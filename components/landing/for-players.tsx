...
import ForPlayersImage from "@/assets/landing/for_players.webp"
...
const ForPlayers = () => {
  ...
  return (
    <section id={SECTIONS.FORPLAYERS} className="w-full px-5 md:px-10 md:py-40 py-20 relative overflow-x-hidden bg-for-p-grad-bg from-[#29C7C7_0%] via-[#77E4E4_18%] to-[transparent_50%]">
      <div className="container mx-auto flex flex-col gap-[30px]">
        <div className="w-2/3 md:w-1/3">
          <SectionTitle title="For Players" />
        </div>
        <div className="flex flex-col items-center  min-[1420px]:flex-row gap-[30px] md:gap-[60px]">
          ...
          <div className="min-[1420px]:absolute -right-20">
            <Image className="xl:w-[715px] xl:h-[668px]" src={ForPlayersImage} alt="for-players-image"/>
          </div>
        </div>
      </div>
    </section>
